            ...
            <Tab eventKey="summary" title="Summary">
                        ...
                        <Plot
                            ...
                            config={{
                                ...
                                toImageButtonOptions: {
                                    ...
                                    filename: `${rnaType === "cptac" ? "CPTAC" : "TCGA"}_RNA_Level_Tumor_vs_Normal-${form.gene.label}`,
                                },
                            }}
                            useResizeHandler
                ...
                <div className="m-3">
                    {<div className="d-flex" style={{ justifyContent: "flex-end" }}>
                        <ExcelFile
                            filename={`${rnaType === "cptac" ? "CPTAC" : "TCGA"}_RNA_Level_TCGA_Tumor_vs_Normal-${form.gene.label}`}
